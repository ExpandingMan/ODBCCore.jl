...
handletype(::Type{SQLEnvironement}) = SQL_HANDLE_ENV
#===================================================================================================
    </SQLEnvironement>
===================================================================================================#
...
#===================================================================================================
    <SQLConnection>
===================================================================================================#
struct SQLConnection <: AbstractSQLHandle
    ptr::Ptr{Void}
end

handletype(::Type{SQLConnection}) = SQL_HANDLE_DBC
#===================================================================================================
    <SQLConnection>
===================================================================================================#
...
#===================================================================================================
    <SQLStatement>
===================================================================================================#
struct SQLStatement <: AbstractSQLHandle
    ptr::Ptr{Void}
end

handletype(::Type{SQLStatement}) = SQL_HANDLE_STMT

# TODO not sure whether this will stay, this is a higher level wrapper of SQLStatement
type Statement
    dsn::DSN
    stmt::Ptr{Void}
    query::String
...
#===================================================================================================
    <SQLDescriptor>
===================================================================================================#
struct SQLDescriptor <: AbstractSQLHandle
    ptr::Ptr{Void}
end

handletype(::Type{SQLDescriptor}) = SQL_HANDLE_DESC
#===================================================================================================
    </SQLDescriptor>
===================================================================================================#


# TODO can't find any information on this...
#===================================================================================================
    <SQLWindow>
===================================================================================================#
struct SQLWindow <: AbstractSQLHandle
    ptr::Ptr{Void}
end
#===================================================================================================
    </SQLWindow>
...
const HANDLETYPE_DICT = Dict(SQL_HANDLE_ENV=>SQLEnvironement,
                             SQL_HANDLE_DBC=>SQLConnection,
                             SQL_HANDLE_STMT=>SQLStatement,
                             SQL_HANDLE_DESC=>SQLDescriptor)

# this is a low level function for constructing handles
makehandle(htype::Integer, ptr::Ptr{Void}) = HANDLETYPE_DICT[Int16(htype)](ptr)
makehandle{T<:AbstractSQLHandle}(::Type{T}, ptr::Ptr{Void}) = T(ptr)
...
ODBCError(hdl::SQLHandle) = ODBCError(hdl.ptr, handletype(hdl))
#===================================================================================================
    <ODBCError>
===================================================================================================#
...
function __init__()
    global const SQLEnv = ODBCAllocHandle(SQL_HANDLE_ENV, SQL_NULL_HANDLE)
end
